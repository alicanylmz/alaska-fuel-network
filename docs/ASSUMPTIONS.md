...
|---|---|---|
| A01 | Static tank capacity is a proxy for demand magnitude | Modeling proxy |
| A02 | Missing demand capacities use five-neighbor inverse-distance estimates | Imputation |
| A03 | Imputed nodes farther than 300 km from observed capacity are removed | Screening rule |
